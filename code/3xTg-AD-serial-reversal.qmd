...
There were no significant effects of genotype, odour pair, nor interactions between genotype and odour pair, in the first (1 - 6), second (7 - 12) or last thirds (13 - 18) of trials (*p*'s \>= `r format(min(c(disc_first_third_aov$p, disc_second_third_aov$p, disc_last_third_aov$p), digits = 2))`; @fig-disc).
